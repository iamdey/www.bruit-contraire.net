...
réutiliser d'anciens composants notamment un vieux clavier mécanique que m'a
donné [@gilles](https://mastodon.xyz/@gilles@social.poolp.org) (tu as vu, il a
une chouette nouvelle vie ;) ) J'ai donc démonté et dessoudé tous les switchs
ainsi que les diodes. C'est beaucoup de taff mais ça évite de jeter du matos et
c'est déjà bien.
